...
@TeleOp(name = "6W 2M Spinner Test 2", group = "")
//@Disabled
public class Spinner_Test_2 extends LinearOpMode {
    ...
    private boolean spinModeVelocity=false;
    ...
    private void spinControls() {
        ...
        telemetry.addData ("spinSpeed2", spinSpeed2);
        telemetry.addData("spinPower", spinPower);
        telemetry.addData("spinRPM", spinRPM);
